...
@section('index')
    ...
    <section class="py-5">
        <div class="bg-holder bg-size"
            style="background-image:url({!! asset('assets/assets/img/gallery/doctors-bg.png') !!});background-position:top center;background-size:contain;">
        </div>
        <!--/.bg-holder-->
                    ...
                    <div class="carousel slide" id="carouselExampleDark" data-bs-ride="carousel"><a
                        ...
                        <div class="carousel-inner">
                            @foreach ($data as $dokter)
                                <div class="carousel-item {{ $dokter->id == 1 ? 'active' : '' }}"
                                        ...
                                        <div class="col-md-12 mb-8 mb-md-0">
                                            <div class="card card-span h-100 shadow">
                                                <div class="card-body d-flex flex-column flex-center py-5"><img
                                                        src="{!! asset('assets/img/gallery/anita.png') !!}" width="128" alt="..." />
